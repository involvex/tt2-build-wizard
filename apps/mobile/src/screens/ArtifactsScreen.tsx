		...
		>
			...
			{results.length > 0 ? (
				<View>
					...
					{results.map((item, index) => (
						<Card
							...
							className="mb-3 border-slate-800 bg-slate-900/50"
						>
							<View className="flex-row justify-between items-center">
								...
								<View className="items-end">
									<Text className="text-slate-400 font-bold text-xs">Cost</Text>
				...
				<View className="items-center py-20 opacity-20">
					...
					<Text className="text-white font-bold">Ready to Optimize</Text>
				</View>
			)}
		</ScrollView>
	)
