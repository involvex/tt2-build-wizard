...
- *Recommendation:* Stick to **Bottom Tabs** for primary sections (Dashboard, Optimizer, Raids, Settings) and use **Stacks** for details. It's more modern and fits the current design.
