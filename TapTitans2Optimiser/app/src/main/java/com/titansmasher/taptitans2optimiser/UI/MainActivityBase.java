package com.titansmasher.taptitans2optimiser.UI;
...
public class MainActivityBase extends AppCompatActivity
    ...
    public void requestReadPermissions(boolean forceRequest) {
        if (!hasPermission(Manifest.permission.READ_EXTERNAL_STORAGE) || forceRequest) {
