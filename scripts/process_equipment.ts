...
const csv = fs.readFileSync('tt2-master/test/TT2Master.Shared.Tests/Resources/EquipmentSetInfo.csv', 'utf8');
...
fs.writeFileSync('packages/logic/src/equipment_sets.json', JSON.stringify(equipmentSets, null, 2));
